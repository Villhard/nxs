...
Accepted input: a task description, a brainstorm brief (`docs/briefs/`), a root-cause brief from `/nxs:bug`, or a Jira key / URL / pasted ticket. A plan can be made with or without a brief - with no input, gather it here first.
